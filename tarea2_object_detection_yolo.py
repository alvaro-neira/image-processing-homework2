...
train_dir = "contentdata/orand-car-with-bbs/training/"
...
display(Image('contentyolov5/runs/train/exp/confusion_matrix.png'))
display(Image('contentyolov5/runs/train/exp/results.png'))
display(Image('contentyolov5/runs/train/exp/val_batch2_labels.jpg'))
display(Image('contentyolov5/runs/train/exp/val_batch2_pred.jpg'))
